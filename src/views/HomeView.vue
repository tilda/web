...
<template>
    <div>
        <p>
            ...
            <a href="https://nctc.edu">North Central Texas College</a>, with an estimated graduation date in december
            2026.
        </p>
        <h2>my favorite...</h2>
        <table class="indent-2">
            <tbody>
                <tr>
                    <th>rhythm games</th>
                    <td>
                        <a href="https://osu.ppy.sh"><i>osu!</i></a>, <i>BEMANI</i> titles*
                    </td>
                </tr>
                <tr>
                    <th>story/narrative games</th>
                    <td><i>Half-Life</i> and <i>Portal</i> series</td>
                </tr>
                <tr>
        ...
        <ol class="list-disc">
            ...
            <li>
                ...
                <a href="https://en.wiktionary.org/wiki/weeaboo#English">weeb</a>.<br>
                growing up, we didn't have cable tv. of course i still caught glimpses of spongebob episodes and such,
                but the internet has... a lot of anime culture. i got used to it and stuck with it to this very day.
            </li>
            <li>
